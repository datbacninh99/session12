...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        // Sắp xếp
        // 1. Sắp xếp danh sách nhân viên theo tên tăng dần / giảm dần
        // Cách Comparable
        Collections.sort(employeeList);
        System.out.println(employeeList);

        // 2. Sắp xếp danh sách nhân viên theo tuổi tăng dần / giảm dần
        ...
        // 3. Sắp xếp danh sách nhân viên theo lương tăng dần / giảm dần
        Collections.sort(employeeList, (o1, o2) -> Double.compare(o1.calTotalSalary(), o2.calTotalSalary()));

        System.out.println(employeeList);

        // 4. Sắp xếp danh sách nhân viên theo id tăng dần / giảm dần
        Collections.sort(employeeList, (o1, o2) -> o1.getId() - o2.getId());

        // 5. Sắp xếp danh sách nhân viên theo tên tăng dần, nếu trùng tên thì sắp xếp theo id tăng dẫn
        // Comparator
